{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/data/github/proj.doCard";
  project_input_ref = "path:/data/github/proj.doCard";
  devenv_dotfile = "/data/github/proj.doCard/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-34c9012";
